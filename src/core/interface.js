...
g.executeAfterDOM(function() {
    ...
    var scale = function(v) {
        if (v < 1) {//pixelate when zooming in
            ...
            g.DOM.picker1.style[g.DOM.transform] = g.DOM.picker1.style[g.DOM.transform].replace(regSc, "leX(" + v);
            g.DOM.picker2.style[g.DOM.transform] = g.DOM.picker2.style[g.DOM.transform].replace(regSc, "leY(" + v);
