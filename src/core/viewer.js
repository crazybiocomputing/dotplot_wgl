...
function ViewManager() {
    ...
    g.DOM.picker1.style[g.DOM.transform] = "translateZ(0) translateX(0px) scaleX(1)";
    g.DOM.picker2.style[g.DOM.transform] = "translateZ(0) translateY(0px) scaleY(1)";
    var regTr = /te[XY]\([^p]*/;
    /**
    ...
    this.pick = function(params) {
        ...
        if (modifiedX) {
            ...
            g.DOM.picker1.style[g.DOM.transform] = g.DOM.picker1.style[g.DOM.transform].replace(regTr, "teX(" + pickX);
        }
        ...
        if (modifiedY) {
            ...
            g.DOM.picker2.style[g.DOM.transform] = g.DOM.picker2.style[g.DOM.transform].replace(regTr, "teY(" + pickY);
        }
